...
router.post("/comment_on_post/:post_id", protect, upload.single("image"), comment_on_post)
router.post("/reply_on_comment/:post_id/:parent_id", protect, upload.single("image"), reply_on_comment);
